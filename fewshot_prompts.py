...
new_task = "To test the hypothesis that serial learning depends largely on the encoding and retrieval of position-to-item associations, we examined whether The participants can learn spin lists on which starting position is randomly varied across successive learning trials. Over the course of the experiment, The participants were asked to learn 27 word lists until they could recite each list without error. The lists consisted of 7, 13, or 19 words selected randomly and without replacement from the noun subset of the Word Pool. We manipulated list length to address the continuity between previous work on immediate serial recall and serial learning. Each list was learned using the procedure of alternating study and test trials, under either constant or varied (i.e., spin) starting position conditions. Thus, the experiment had a 3 * 2 within-subjects design, with three list lengths (7, 13, and 19) and two starting position conditions (constant and spin). In the constant starting position condition, the participants studied lists in the usual manner of multitrial serial recall. The presentation of the list on each study trial was kept in the same order and began with the same word. The participants were asked to recall the list in the presented order. In the spin condition, the order of the list items was again kept constant. Each study trial, however, began with a randomly selected item in the list and continued in order from that item, wrapping around through all the items in the list (see Table 1 for example study–test trials). No item was used on more than one study–test trial to begin the list. The participants were asked to recall the list in the order presented on the most recent study trial. The participants were tested in four separate sessions. The practice session consisted of three lists for each starting position condition, one of each list length. The participants were informed of the list structure and starting position manipulation. Each of the three subsequent test sessions consisted of nine lists from one of the two starting position conditions—three lists of each of the three lengths (7, 13, and 19) in random order. The order of the spin and control conditions alternated across sessions and was counterbalanced across participants. During study, words were presented at a rate of 1 word/ sec.The participants were given up to 1 min to recall as many words from the list as possible, and they indicated their completion of recall for the current trial by saying “done.” Study–test trials were continued until the participants recalled the entire list in the correct order, or until a predetermined maximum number of trials was reached (for list length 7, 7 trials; for list length 13, 13 trials; and for list length 19, 16 trials)."
